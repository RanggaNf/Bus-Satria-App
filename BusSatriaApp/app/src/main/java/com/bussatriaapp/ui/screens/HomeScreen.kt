        ...
        item {
            ...
            item {
                ...
                Row(
                    ...
                    StatisticCard(title = "Perjalanan", value = "3", color = cardColor, textColor = textColor, iconColor = Color(0xFF4CAF50))
                    StatisticCard(title = "Jarak", value = "15 km", color = cardColor, textColor = textColor, iconColor = Color(0xFF2196F3))
                    StatisticCard(title = "Poin", value = "150", color = cardColor, textColor = textColor, iconColor = Color(0xFFFFA000))
                }
            }
            ...
            items(3) { index ->
                ActivityItem(
                    title = "Perjalanan ${250 + index} kali" ,
        ...
        Column(
            ...
            Icon(
                imageVector = when (title) {
                    "Perjalanan" -> Icons.Default.DirectionsBus
                    "Jarak" -> Icons.Default.Timeline
                    "Poin" -> Icons.Default.Stars
