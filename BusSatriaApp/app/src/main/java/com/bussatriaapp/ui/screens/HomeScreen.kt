            ...
            item {
                ...
                item {
                    ...
                    Row(
                        ...
                        StatisticCard(
                            title = "Jarak(km)",
                            value = userStats.formattedDistance,
                            color = cardColor,
                            textColor = textColor,
                ...
                if (userActivities.isEmpty()) {
                    ...
                    items(userActivities.sortedByDescending { it.time }.take(10)) { activity ->
                        ActivityItem(
                            title = activity.title,
                            description = activity.description,
                            time = getRelativeTimeSpan(activity.time),
                            color = cardColor,
                            textColor = textColor
                        )
                    }
            ...
            Column(
                ...
                Icon(
                    imageVector = when (title) {
                        ...
                        "Jarak(km)" -> Icons.Default.Timeline
    ...
    fun getRelativeTimeSpan(timeString: String): String {
        ...
        val date = format.parse(timeString) ?: return ""
